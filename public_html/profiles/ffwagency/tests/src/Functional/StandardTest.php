...
namespace Drupal\Tests\ffwagency\Functional;
...
/**
 * Tests ffwagency installation profile expectations.
 *
 * @group ffwagency
 */
class FFWAgencyTest extends BrowserTestBase {

  use SchemaCheckTestTrait;

  protected $profile = 'ffwagency';
  ...
  /**
   * Tests ffwagency installation profile.
   */
  function testFFWAgency() {
    $this->drupalGet('');
    ...
    // ffwagency profile modules are enabled.
    ...
    // Ensure that configuration from the ffwagency profile is not reused when
